...
int main() {
    mpengine::BasicIntegerType X(10, mpengine::IOBasic::dec), Y(10, mpengine::IOBasic::dec), Z(10, mpengine::IOBasic::dec);
    ...
    mpengine::u64_variable_length_integer_multiplication_c_2len_with_carry(X.get_pointer(), Y.get_pointer(), Z.get_pointer(), X.len, mpengine::iofun::store_base(X.iobasic));
