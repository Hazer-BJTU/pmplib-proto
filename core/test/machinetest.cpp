...
public:
    ...
    MyAutomaton(): num(0), exp(0), fraction_digit(1), sign_num(1), sign_exp(1) {
        ...
        add_transitions("initial", "integer_part", "0123456789", [this] { num = num * 10 + current_event - '0'; });
        add_transition("initial", "fractional_part", '.', [this] { fraction_digit = 0.1; });
        add_transitions("num_sign", "integer_part", "0123456789", [this] { num = num * 10 + current_event - '0'; });
        add_transition("num_sign", "fractional_part", '.', [this] { fraction_digit = 0.1; });
        add_transitions("integer_part", "integer_part", "0123456789", [this] { num = num * 10 + current_event - '0'; });
        add_transition("integer_part", "fractional_part", '.', [this] { fraction_digit = 0.1; } );
        add_transitions("integer_part", "exp_symbol", "Ee");
        add_transitions("fractional_part", "fractional_part", "0123456789", [this] { num += (current_event - '0') * fraction_digit; fraction_digit /= 10; } );
        add_transitions("fractional_part", "exp_symbol", "Ee");
        add_transition("exp_symbol", "exp_sign", '+');
        add_transition("exp_symbol", "exp_sign", '-', [this] { sign_exp = 0; });
        add_transitions("exp_symbol", "exp_part", "0123456789", [this] { exp = exp * 10 + current_event - '0'; });
        add_transitions("exp_sign", "exp_part", "0123456789", [this] { exp = exp * 10 + current_event - '0'; });
        add_transitions("exp_part", "exp_part", "0123456789", [this] { exp = exp * 10 + current_event - '0'; });
