...
TerminateCalls TerminateCalls::terminate_handler_instance;

TerminateCalls::TerminateCalls(): callbacks() {
    std::set_terminate([]() {
        auto& handler = ::putils::TerminateCalls::get_terminate_handler();
        TerminateCalls::CallbackList callbacks(handler.get_terminate_callbacks());
...
TerminateCalls::CallbackList TerminateCalls::get_terminate_callbacks() noexcept {
...
void Logger::register_exit() noexcept {
    ...
    handler.register_terminate([this]() {
        try {
